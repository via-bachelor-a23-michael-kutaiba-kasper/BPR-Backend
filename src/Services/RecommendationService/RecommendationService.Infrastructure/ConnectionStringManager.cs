...
public class ConnectionStringManager: IConnectionStringManager
{
    ...
    public ConnectionStringManager()
    {
        ...
        _connectionStrings.Add($"PRODUCTION", $"Server=35.234.109.192;Port=5432;Database=postgres;User Id=postgres;Password={password}");
        _connectionStrings.Add($"CI", $"Server=34.107.56.249;Port=5432;Database=postgres;User Id=postgres;Password={password}");
