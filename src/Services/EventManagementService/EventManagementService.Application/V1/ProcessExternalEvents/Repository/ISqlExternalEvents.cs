...
using EventManagementService.Application.V1.ProcessExternalEvents.Sql;
using EventManagementService.Application.V1.ProcessExternalEvents.Util;
...
namespace EventManagementService.Application.V1.ProcessExternalEvents.Repository;
